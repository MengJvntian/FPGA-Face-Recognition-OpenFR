...
`define IP_UUID _488a93746a75487f8d6775d337c8ed10
...
// Component : EfxDMA_488a93746a75487f8d6775d337c8ed10

`timescale 1ns/1ps

module EfxDMA_488a93746a75487f8d6775d337c8ed10 (
  ...
  EfxDMA_Core_488a93746a75487f8d6775d337c8ed10 core (
  ...
  EfxDMA_Apb3CC_488a93746a75487f8d6775d337c8ed10 withCtrlCc_apbCc (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_10_488a93746a75487f8d6775d337c8ed10 io_interrupts_buffercc (
    .io_dataIn  (core_io_interrupts[3:0]               ), //i
    .io_dataOut (io_interrupts_buffercc_io_dataOut[3:0]), //o
    .ctrl_clk   (ctrl_clk                              ), //i
    .ctrl_reset (ctrl_reset                            )  //i
  );
  EfxDMA_BmbSourceRemover_488a93746a75487f8d6775d337c8ed10 readLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4ReadOnlyBridge_488a93746a75487f8d6775d337c8ed10 readLogic_bridge (
  ...
  EfxDMA_BmbSourceRemover_1_488a93746a75487f8d6775d337c8ed10 writeLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4WriteOnlyBridge_488a93746a75487f8d6775d337c8ed10 writeLogic_bridge (
  ...
  EfxDMA_StreamFifoCC_488a93746a75487f8d6775d337c8ed10 inputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_BsbUpSizerDense_488a93746a75487f8d6775d337c8ed10 inputsAdapter_1_upsizer_logic (
  ...
  EfxDMA_StreamFifoCC_1_488a93746a75487f8d6775d337c8ed10 inputsAdapter_1_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_2_488a93746a75487f8d6775d337c8ed10 outputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_3_488a93746a75487f8d6775d337c8ed10 outputsAdapter_1_crossclock_fifo (
  ...
  EfxDMA_BsbDownSizerSparse_488a93746a75487f8d6775d337c8ed10 outputsAdapter_1_sparseDownsizer_logic (
...
module EfxDMA_BsbDownSizerSparse_488a93746a75487f8d6775d337c8ed10 (
...
module EfxDMA_StreamFifoCC_3_488a93746a75487f8d6775d337c8ed10 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10 popToPushGray_buffercc (
    .io_dataIn  (popToPushGray[4:0]                    ), //i
    .io_dataOut (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_9_488a93746a75487f8d6775d337c8ed10 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifoCC_2_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [63:0]   io_push_payload_data,
  input  wire [7:0]    io_push_payload_mask,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_7_488a93746a75487f8d6775d337c8ed10 pushToPopGray_buffercc (
    .io_dataIn    (pushToPopGray[4:0]                    ), //i
    .io_dataOut   (pushToPopGray_buffercc_io_dataOut[4:0]), //o
    .dat1_o_clk   (dat1_o_clk                            ), //i
    .dat1_o_reset (dat1_o_reset                          )  //i
...
module EfxDMA_StreamFifoCC_1_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [63:0]   io_push_payload_data,
  input  wire [7:0]    io_push_payload_mask,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_4_488a93746a75487f8d6775d337c8ed10 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat2_i_clk   (dat2_i_clk                            ), //i
    .dat2_i_reset (dat2_i_reset                          )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10 pushToPopGray_buffercc (
    .io_dataIn  (pushToPopGray[4:0]                    ), //i
    .io_dataOut (pushToPopGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
...
module EfxDMA_BsbUpSizerDense_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_valid,
  output wire          io_input_ready,
...
module EfxDMA_StreamFifoCC_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [63:0]   io_push_payload_data,
  input  wire [7:0]    io_push_payload_mask,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_2_488a93746a75487f8d6775d337c8ed10 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat0_i_clk   (dat0_i_clk                            ), //i
    .dat0_i_reset (dat0_i_reset                          )  //i
...
module EfxDMA_BmbToAxi4WriteOnlyBridge_488a93746a75487f8d6775d337c8ed10 (
  ...
  EfxDMA_BmbContextRemover_1_488a93746a75487f8d6775d337c8ed10 contextRemover (
...
module EfxDMA_BmbSourceRemover_1_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
...
module EfxDMA_BmbToAxi4ReadOnlyBridge_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_BmbContextRemover_488a93746a75487f8d6775d337c8ed10 contextRemover (
    .io_input_cmd_valid                     (io_input_cmd_valid                                         ), //i
    .io_input_cmd_ready                     (contextRemover_io_input_cmd_ready                          ), //o
    .io_input_cmd_payload_last              (io_input_cmd_payload_last                                  ), //i
    .io_input_cmd_payload_fragment_opcode   (io_input_cmd_payload_fragment_opcode                       ), //i
...
module EfxDMA_BmbSourceRemover_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_source,
...
module EfxDMA_BufferCC_10_488a93746a75487f8d6775d337c8ed10 (
...
module EfxDMA_Apb3CC_488a93746a75487f8d6775d337c8ed10 (
  ...
  EfxDMA_FlowCCUnsafeByToggle_488a93746a75487f8d6775d337c8ed10 flowCCUnsafeByToggle (
  ...
  EfxDMA_FlowCCUnsafeByToggle_1_488a93746a75487f8d6775d337c8ed10 flowCCUnsafeByToggle_1 (
...
module EfxDMA_Core_488a93746a75487f8d6775d337c8ed10 (
  ...
  EfxDMA_DmaMemoryCore_488a93746a75487f8d6775d337c8ed10 memory_core (
  ...
  EfxDMA_Aggregator_488a93746a75487f8d6775d337c8ed10 b2m_fsm_aggregate_engine (
...
module EfxDMA_BufferCC_9_488a93746a75487f8d6775d337c8ed10 (
...
//EfxDMA_BufferCC_8 replaced by EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10

module EfxDMA_BufferCC_7_488a93746a75487f8d6775d337c8ed10 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          dat1_o_clk,
  input  wire          dat1_o_reset
...
//EfxDMA_BufferCC_6 replaced by EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10

//EfxDMA_BufferCC_5 replaced by EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10

module EfxDMA_BufferCC_4_488a93746a75487f8d6775d337c8ed10 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          dat2_i_clk,
  input  wire          dat2_i_reset
...
module EfxDMA_BufferCC_3_488a93746a75487f8d6775d337c8ed10 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          clk,
  input  wire          reset
...
module EfxDMA_BufferCC_2_488a93746a75487f8d6775d337c8ed10 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          dat0_i_clk,
  input  wire          dat0_i_reset
...
module EfxDMA_BmbContextRemover_1_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_cmd_valid,
  ...
  EfxDMA_StreamFifo_1_488a93746a75487f8d6775d337c8ed10 fifoFork_thrown_translated_fifo (
...
module EfxDMA_BmbContextRemover_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_cmd_valid,
  output reg           io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_StreamFifo_488a93746a75487f8d6775d337c8ed10 fifoFork_thrown_translated_fifo (
    .io_push_valid           (fifoFork_thrown_translated_valid                            ), //i
    .io_push_ready           (fifoFork_thrown_translated_fifo_io_push_ready               ), //o
...
module EfxDMA_FlowCCUnsafeByToggle_1_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_valid,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_1_488a93746a75487f8d6775d337c8ed10 inputArea_target_buffercc (
...
module EfxDMA_FlowCCUnsafeByToggle_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_valid,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_488a93746a75487f8d6775d337c8ed10 inputArea_target_buffercc (
    .io_dataIn  (inputArea_target                    ), //i
    .io_dataOut (inputArea_target_buffercc_io_dataOut), //o
    .clk        (clk                                 ), //i
    .reset      (reset                               )  //i
...
module EfxDMA_Aggregator_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_input_valid,
...
module EfxDMA_DmaMemoryCore_488a93746a75487f8d6775d337c8ed10 (
...
module EfxDMA_StreamFifo_1_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_StreamFifo_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_BufferCC_1_488a93746a75487f8d6775d337c8ed10 (
...
module EfxDMA_BufferCC_488a93746a75487f8d6775d337c8ed10 (
  input  wire          io_dataIn,
  output wire          io_dataOut,
  input  wire          clk,
  input  wire          reset
