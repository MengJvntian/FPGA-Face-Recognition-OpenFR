...
module edb_top (
    ...
    input  mem_clk,
    input  mem_error,
    input  [15:0] mem_err_cnt,
    input  [29:0] mem_err_addr,
    input  [7:0] mem_err_position,
    input  [63:0] mem_ref_data,
    input  [63:0] mem_err_data,
    input  mem_cal_done,
    input  [23:0] mem_TestTime,
    input  [47:0] mem_OpTotCyc,
    input  [47:0] mem_OpActCyc,
    input  [9:0] mem_OpEffic,
    input  [9:0] mem_RdOpEffic,
    input  [9:0] mem_WrOpEffic,
    input  [9:0] mem_WrPeriMin,
    input  [9:0] mem_WrPeriAvg,
    input  [9:0] mem_WrPeriMax,
    input  [9:0] mem_RdPeriMin,
    input  [9:0] mem_RdPeriAvg,
    input  [9:0] mem_RdPeriMax,
    input  mem_TimeOut,
    output mem_mode_en,
    output [1:0] mem_axi_mode,
    output [1:0] mem_addr_mode,
    output [2:0] mem_len_mode,
    output [1:0] mem_data_mode,
    output [29:0] mem_saddr,
    output [29:0] mem_faddr,
    output [63:0] mem_fdata,
    output [7:0] mem_flen,
    output mem_ddr_reset,
    output mem_StatiClr,
    input  phy_debug_clk,
    input  phy_debug_idelay_ld,
    input  phy_debug_mpr_rdlvl_dly,
    input  [7:0] phy_debug_wrlvl_dq_check,
    input  [7:0] phy_debug_rd_level_dqs_check,
    input  phy_debug_pll_shift_ena,
    input  [4:0] phy_debug_pll_shift_sel,
    input  [2:0] phy_debug_pll_shift,
    input  phy_debug_ddr_cs_n,
    input  phy_debug_ddr_ras_n,
    input  phy_debug_ddr_cas_n,
    input  phy_debug_ddr_we_n,
    input  [15:0] phy_debug_ddr_addr,
    input  [2:0] phy_debug_ddr_ba,
    input  phy_debug_ddr_dqs_oe,
    input  phy_debug_ddr_dq_oe,
    input  [1:0] phy_debug_ddr_dqs_in_hi,
    input  [1:0] phy_debug_ddr_dqs_in_lo,
    input  [15:0] phy_debug_ddr_dq_in_hi,
    input  [15:0] phy_debug_ddr_dq_in_lo,
    input  [1:0] phy_debug_ddr_dqs_out_hi,
    input  [1:0] phy_debug_ddr_dqs_out_lo,
    input  [15:0] phy_debug_ddr_dq_out_hi,
    input  [15:0] phy_debug_ddr_dq_out_lo,
    input  phy_debug_error,
    input  [6:0] phy_debug_init_cur_state,
    input  [2:0] phy_debug_rdlvl_shift,
    input  [2:0] phy_debug_wrlvl_shift,
    input  la0_clk,
    input  la0_s_axi_awvalid,
    input  la0_s_axi_awready,
    input  [31:0] la0_s_axi_awaddr,
    input  [7:0] la0_s_axi_awlen,
    input  [2:0] la0_s_axi_awsize,
    input  la0_s_axi_wready,
    input  la0_s_axi_wvalid,
    input  [63:0] la0_s_axi_wdata,
    input  la0_s_axi_wlast,
    input  la0_s_axi_bvalid,
    input  la0_s_axi_bready,
    input  [1:0] la0_s_axi_bresp,
    input  la0_s_axi_arvalid,
    input  la0_s_axi_arready,
    input  [31:0] la0_s_axi_araddr,
    input  [7:0] la0_s_axi_arlen,
    input  la0_s_axi_rready,
    input  la0_s_axi_rvalid,
    input  [63:0] la0_s_axi_rdata,
    input  [1:0] la0_s_axi_rresp,
    input  la0_s_axi_rlast,
    input  la0_error,
    input  [35:0] la0_ddr_debug_port,
    input  [15:0] la0_err_cnt,
    input  [31:0] la0_err_addr,
    input  [7:0] la0_err_position,
    input  [63:0] la0_ref_data,
    input  [63:0] la0_err_data
);
    ...
    wire mem_module_select;
    wire mem_module_inhibit;
    wire mem_module_tdo;

    wire phy_debug_module_select;
    wire phy_debug_module_inhibit;
    wire phy_debug_module_tdo;

    wire la0_module_select;
    wire la0_module_inhibit;
    wire la0_module_tdo;

    assign mem_module_select        = edb_module_selects[0];
    assign edb_module_inhibit[0]    = mem_module_inhibit;
    assign edb_module_tdo[0]        = mem_module_tdo;
    assign phy_debug_module_select      = edb_module_selects[1];
    assign edb_module_inhibit[1]    = phy_debug_module_inhibit;
    assign edb_module_tdo[1]        = phy_debug_module_tdo;
    assign la0_module_select        = edb_module_selects[2];
    assign edb_module_inhibit[2]    = la0_module_inhibit;
    assign edb_module_tdo[2]        = la0_module_tdo;
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 20 ),
        .NUM_PROBE_OUT          ( 11 ),
        .UUID           ( 128'hbc6ea50f1a674b37854a0de5afacac6d ),
        .PROBE_IN0_WIDTH        ( 1 ),
        .PROBE_IN1_WIDTH        ( 16 ),
        .PROBE_IN2_WIDTH        ( 30 ),
        .PROBE_IN3_WIDTH        ( 8 ),
        ...
        .edb_module_select  ( mem_module_select  ),
        .edb_module_inhibit ( mem_module_inhibit ),
        .edb_module_tdo     ( mem_module_tdo ),
        .clk                ( mem_clk ),
        .probe_in0          ( mem_error ),
        .probe_in1          ( mem_err_cnt ),
        .probe_in2          ( mem_err_addr ),
        .probe_in3          ( mem_err_position ),
        .probe_in4          ( mem_ref_data ),
        .probe_in5          ( mem_err_data ),
        .probe_in6          ( mem_cal_done ),
        .probe_in7          ( mem_TestTime ),
        .probe_in8          ( mem_OpTotCyc ),
        .probe_in9          ( mem_OpActCyc ),
        .probe_in10         ( mem_OpEffic ),
        .probe_in11         ( mem_RdOpEffic ),
        .probe_in12         ( mem_WrOpEffic ),
        .probe_in13         ( mem_WrPeriMin ),
        .probe_in14         ( mem_WrPeriAvg ),
        .probe_in15         ( mem_WrPeriMax ),
        .probe_in16         ( mem_RdPeriMin ),
        .probe_in17         ( mem_RdPeriAvg ),
        .probe_in18         ( mem_RdPeriMax ),
        .probe_in19         ( mem_TimeOut ),
        .probe_in20         ( 1'b0 ),
        .probe_in21         ( 1'b0 ),
        .probe_in22         ( 1'b0 ),
        .probe_in23         ( 1'b0 ),
        ...
        .probe_in62         ( 1'b0 ),
        .probe_in63         ( 1'b0 ),
        .probe_out0         ( mem_mode_en ),
        .probe_out1         ( mem_axi_mode ),
        .probe_out2         ( mem_addr_mode ),
        .probe_out3         ( mem_len_mode ),
        .probe_out4         ( mem_data_mode ),
        .probe_out5         ( mem_saddr ),
        .probe_out6         ( mem_faddr ),
        .probe_out7         ( mem_fdata ),
        .probe_out8         ( mem_flen ),
        .probe_out9         ( mem_ddr_reset ),
        .probe_out10            ( mem_StatiClr ),
        .probe_out11            (  ),
        .probe_out12            (  ),
        .probe_out13            (  ),
        .probe_out14            (  ),
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h405cf2bd6ebc4bca9b18b1a068b16206 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .bscan_UPDATE                   ( bscan_UPDATE ),
        .edb_user_dr            ( edb_user_dr ),
        .edb_module_select      ( phy_debug_module_select  ),
        .edb_module_inhibit     ( phy_debug_module_inhibit ),
        .edb_module_tdo         ( phy_debug_module_tdo ),
        .clk                    ( phy_debug_clk ),
        .trig_in                ( 1'b0 ),
        .trig_in_ack            (  ),
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( phy_debug_idelay_ld ),
        .probe1                 ( phy_debug_mpr_rdlvl_dly ),
        .probe2                 ( phy_debug_wrlvl_dq_check ),
        .probe3                 ( phy_debug_rd_level_dqs_check ),
        .probe4                 ( phy_debug_pll_shift_ena ),
        .probe5                 ( phy_debug_pll_shift_sel ),
        .probe6                 ( phy_debug_pll_shift ),
        .probe7                 ( phy_debug_ddr_cs_n ),
        .probe8                 ( phy_debug_ddr_ras_n ),
        .probe9                 ( phy_debug_ddr_cas_n ),
        .probe10                    ( phy_debug_ddr_we_n ),
        .probe11                    ( phy_debug_ddr_addr ),
        .probe12                    ( phy_debug_ddr_ba ),
        .probe13                    ( phy_debug_ddr_dqs_oe ),
        .probe14                    ( phy_debug_ddr_dq_oe ),
        .probe15                    ( phy_debug_ddr_dqs_in_hi ),
        .probe16                    ( phy_debug_ddr_dqs_in_lo ),
        .probe17                    ( phy_debug_ddr_dq_in_hi ),
        .probe18                    ( phy_debug_ddr_dq_in_lo ),
        .probe19                    ( phy_debug_ddr_dqs_out_hi ),
        .probe20                    ( phy_debug_ddr_dqs_out_lo ),
        .probe21                    ( phy_debug_ddr_dq_out_hi ),
        .probe22                    ( phy_debug_ddr_dq_out_lo ),
        .probe23                    ( phy_debug_error ),
        .probe24                    ( phy_debug_init_cur_state ),
        .probe25                    ( phy_debug_rdlvl_shift ),
        .probe26                    ( phy_debug_wrlvl_shift )
    );
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hcfe5445673e94c798a51bde4aadf50b5 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( la0_s_axi_awvalid ),
        .probe1                 ( la0_s_axi_awready ),
        .probe2                 ( la0_s_axi_awaddr ),
        .probe3                 ( la0_s_axi_awlen ),
        .probe4                 ( la0_s_axi_awsize ),
        .probe5                 ( la0_s_axi_wready ),
        .probe6                 ( la0_s_axi_wvalid ),
        .probe7                 ( la0_s_axi_wdata ),
        .probe8                 ( la0_s_axi_wlast ),
        .probe9                 ( la0_s_axi_bvalid ),
        .probe10                    ( la0_s_axi_bready ),
        .probe11                    ( la0_s_axi_bresp ),
        .probe12                    ( la0_s_axi_arvalid ),
        .probe13                    ( la0_s_axi_arready ),
        .probe14                    ( la0_s_axi_araddr ),
        .probe15                    ( la0_s_axi_arlen ),
        .probe16                    ( la0_s_axi_rready ),
        .probe17                    ( la0_s_axi_rvalid ),
        .probe18                    ( la0_s_axi_rdata ),
        .probe19                    ( la0_s_axi_rresp ),
        .probe20                    ( la0_s_axi_rlast ),
        .probe21                    ( la0_error ),
        .probe22                    ( la0_ddr_debug_port ),
        .probe23                    ( la0_err_cnt ),
        .probe24                    ( la0_err_addr ),
        .probe25                    ( la0_err_position ),
        .probe26                    ( la0_ref_data ),
        .probe27                    ( la0_err_data )
    );
